          ...
          <div className="max-w-5xl mx-auto">
            ...
            {categories.map((category) => {
              ...
              const categoryColors: {
                ...
                Documentation: {
                  bg: "from-blue-900/20 to-blue-950/20",
                  text: "text-blue-400",
                  icon: "bg-blue-500/20",
                },
                Programming: {
                ...
                Community: {
                  bg: "from-pink-900/20 to-pink-950/20",
                  text: "text-pink-400",
                  icon: "bg-pink-500/20",
                },
                Assets: {
                ...
                Design: {
                  bg: "from-orange-900/20 to-orange-950/20",
              ...
              const colors = categoryColors[category] || {
                bg: "from-gray-900/20 to-gray-950/20",
                text: "text-gray-400",
                icon: "bg-gray-500/20",
              };
              ...
              return (
                <div key={category} className="mb-12">
                  <h3
                    className={`text-2xl font-bold mb-6 flex items-center gap-3 ${colors.text}`}
                  >
                    {category}
                  </h3>
                      ...
                      return (
                        ...
                        >
                          <div className="flex items-start gap-4">
                            <div
                              className={`p-3 rounded-lg ${colors.icon} flex-shrink-0`}
                            >
